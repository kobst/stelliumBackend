...
import { decodePlanetHouseCode, decodeAspectCodeMap, decodeRulerCode } from "../utilities/archive/decoder.js";
...
export async function getCompletionGptResponseRelationshipChatThread(query, contextFromRelationship, contextFromUserA, contextFromUserB, chatHistory, userAName = 'User A', userBName = 'User B') {
...
export async function generateRelationshipPrompt(userAName, userBName, categoryDisplayName, relationshipScores, formattedAstrology, contextA, contextB) {
    return `
...
export async function getCompletionForRelationshipCategory(userAName, userBName, categoryDisplayName, relationshipScores, formattedAstrology, contextA, contextB) {
    try {
