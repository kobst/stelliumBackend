// @ts-nocheck
import { orbCodes, planetCodes, signCodes, relevantPromptAspectsV2, rulers, transitCodes } from "../constants.js";
import { decodePlanetHouseCode, decodeRulerCode } from "../archive/decoder.js";
...
function findAspects(planetName, birthData, closeOnly = false) {
    let aspectList = [];
    const aspectsSorted = birthData.aspects.filter(aspect => aspect.aspecting_planet === planetName ||
