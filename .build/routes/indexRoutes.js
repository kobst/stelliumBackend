...
import { handleUserCreation, handleCreateRelationship, handleGetTransitWindows } from '../controllers/astroDataController.js';
import { 
// gpt
handleShortOverviewResponse, handleShortOverviewRomanticResponse, handleShortOverviewPlanetResponse, handleShortOverviewAllPlanetsResponse, handleBirthChartAnalysis, handleSubtopicAnalysis, handleVectorizeBirthChartAnalysisLog, handleVectorizeTopicAnalysis, handleFetchAnalysis, handleVectorizeRelationshipAnalysis, handleProcessUserQueryForBirthChartAnalysis, handleFetchUserChatBirthChartAnalysis, handleProcessUserQueryForRelationshipAnalysis, handleFetchUserChatRelationshipAnalysis } from '../controllers/gptController.js';
import { handleSaveCompositeChartProfile, handleSaveSynastryChartInterpretation, handleGetUsers, handleGetUserSingle, handleGetCompositeCharts, handleGetRelationshipScore, handleFetchRelationshipAnalysis, handleGenerateRelationshipAnalysis } from '../controllers/dbDataController.js';
